...
cloud = Cloud(os.path.join(os.path.dirname(__file__), '../data/mesa.pcd'))
...
# Pass through
cloud.pass_through( "z", 0.5, 1)

# Ransac
cloud.ransac(0.002, True)

# Grabar el resultado en disco
filename = os.path.join(os.path.dirname(__file__), '../data/mesa_only.pcd')
